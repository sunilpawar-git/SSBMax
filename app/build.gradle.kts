...
dependencies {
    ...
    implementation("androidx.compose.material:material:1.11.3") // For pull-to-refresh
    ...
    kapt("androidx.hilt:hilt-compiler:1.3.0")  // AndroidX Hilt compiler for @HiltWorker
