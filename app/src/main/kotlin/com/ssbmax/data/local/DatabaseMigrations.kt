...
object DatabaseMigrations {
    ...
    /**
     * Adds the single-row oir_sync_metadata table that powered content-version
     * reconciliation (Firestore is SSOT; Room mirrored it). The owning entity/DAO/table
     * were deleted in the KMP-convergence plan's Phase 9a along with the rest of the OIR
     * Room cache; this migration is kept purely for upgrade-path history on old installs.
     */
