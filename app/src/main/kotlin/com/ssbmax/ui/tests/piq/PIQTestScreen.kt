...
import com.ssbmax.ui.tests.piq.components.PIQDropdownField
import com.ssbmax.ui.tests.piq.components.PIQNavigationBar
import com.ssbmax.ui.tests.piq.components.PIQPrivacyWarningBanner
import com.ssbmax.ui.tests.piq.components.PIQSectionHeader
import com.ssbmax.ui.tests.piq.components.PIQTextField
                ...
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(onClick = onNavigateBack) {
                            Icon(Icons.AutoMirrored.Filled.ArrowBack, stringResource(R.string.piq_back))
                        }
                    },
                    actions = {
                        // Show save indicator
...
private fun Page1Content(
    ...
    Column(
        ...
        PIQPage1HeaderSection(answers, onFieldChange)
        PIQPage1ResidenceSection(answers, onFieldChange)
        PIQPage1PersonalDetailsSection(answers, onFieldChange)
        PIQPage1FamilyEnhancementSection(answers, onFieldChange)
        PIQPage1ParentsSection(answers, onFieldChange)
        PIQPage1SiblingsSection(answers, onFieldChange)
        PIQPage1EducationSection(answers, onFieldChange)
...
@Composable
private fun PIQPage1HeaderSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage1ResidenceSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage1PersonalDetailsSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage1FamilyEnhancementSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage1ParentsSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage1SiblingsSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
    ...
    PIQSiblingFields("elderSibling", answers, onFieldChange) { index -> stringResource(R.string.piq_sibling_name, index + 1) }
    ...
    PIQSiblingFields("youngerSibling", answers, onFieldChange) { index -> stringResource(R.string.piq_sibling_name_younger, index + 1) }
}

@Composable
private fun PIQSiblingFields(
    prefixBase: String,
    answers: Map<String, String>,
    onFieldChange: (String, String) -> Unit,
    nameLabel: @Composable (Int) -> String
) {
    repeat(2) { index ->
        val prefix = "$prefixBase${index + 1}_"
        PIQTextField(
            label = nameLabel(index),
...
@Composable
private fun PIQPage1EducationSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
    // Educational Record - moved from Page 2 to end of Page 1
    PIQSectionHeader(stringResource(R.string.piq_educational_record))
    PIQEducation10thFields(answers, onFieldChange)
    PIQEducation12thFields(answers, onFieldChange)
    PIQEducationGraduationFields(answers, onFieldChange)
    PIQEducationPostGraduationFields(answers, onFieldChange)
}

@Composable
private fun PIQEducation10thFields(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQEducation12thFields(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQEducationGraduationFields(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQEducationPostGraduationFields(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
private fun Page2Content(
    ...
    Column(
        ...
        PIQPage2PhysicalAndOccupationSection(answers, onFieldChange)
        PIQPage2NccSection(answers, onFieldChange)
        PIQPage2ActivitiesSection(answers, onFieldChange)
        PIQPage2ServiceSelectionSection(answers, onFieldChange)
...
@Composable
private fun PIQPage2PhysicalAndOccupationSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage2NccSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage2ActivitiesSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
...
@Composable
private fun PIQPage2ServiceSelectionSection(answers: Map<String, String>, onFieldChange: (String, String) -> Unit) {
