...
fun GPEReviewPhase(
    ...
    Column(
        ...
        GPEReviewScenarioCard(scenario, resources)
        GPEReviewPlanningResponseCard(planningResponse, charactersCount, onEdit)
...
@Composable
private fun GPEReviewScenarioCard(scenario: String, resources: List<String>) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        colors = CardDefaults.cardColors(
...
@Composable
private fun GPEReviewPlanningResponseCard(planningResponse: String, charactersCount: Int, onEdit: () -> Unit) {
    Card(
        modifier = Modifier.fillMaxWidth()
    ) {
        Column(
