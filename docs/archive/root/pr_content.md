...
**Root Cause:** Race condition in `UserProfileViewModel` where synchronous auth state access failed when ViewModel initialized before Firebase auth was ready.
