 ...
 * KMP port of core:data's `TATStoryAnalysisPrompts` (verbatim logic; only the
 * package changed, since the original had zero Android dependencies).
 * Mirrors [PPDTPrompts] but scoped to a single TAT story+image pair.
 */
object TATStoryAnalysisPrompts {
