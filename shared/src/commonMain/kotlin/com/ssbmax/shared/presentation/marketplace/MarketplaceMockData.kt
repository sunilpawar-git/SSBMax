...
/**
 * KMP port of the Android `app/.../ui/marketplace/MarketplaceMockData.kt`.
 * Pure data, no Android/Compose dependency in the original -- straight copy.
 *
 * Note: this is mock data (no backend yet), same as the Android original --
 * `MarketplaceViewModel`'s class doc explains the TODOs for a real
 * `MarketplaceRepository` are still open on both platforms.
 */
