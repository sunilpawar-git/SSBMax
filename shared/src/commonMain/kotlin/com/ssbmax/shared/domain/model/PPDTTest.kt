...
data class PPDTSubmission(
    ...
    val analysisStatus: com.ssbmax.shared.domain.model.scoring.AnalysisStatus = com.ssbmax.shared.domain.model.scoring.AnalysisStatus.PENDING_ANALYSIS,
    val olqResult: com.ssbmax.shared.domain.model.scoring.OLQAnalysisResult? = null
) {
