  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300" data-testid="candidate-dashboard">
      ...
      <div className="bg-slate-800/80 border border-slate-700/80 rounded-2xl p-6 shadow-lg backdrop-blur-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-700/80 hover:bg-slate-700 border border-slate-600/60 text-xs font-semibold text-slate-200 transition-colors shadow-sm self-start md:self-auto"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-4 border-t border-slate-700/60 text-xs">
          <div className="bg-slate-900/60 p-3 rounded-xl border border-slate-800">
            ...
            <span className="font-bold text-slate-200 flex items-center gap-1.5" data-testid="meta-board">
          ...
          <div className="bg-slate-900/60 p-3 rounded-xl border border-slate-800">
            ...
            <span className="font-bold text-slate-200 flex items-center gap-1.5" data-testid="meta-entry">
          ...
          <div className="bg-slate-900/60 p-3 rounded-xl border border-slate-800">
            ...
            <span className="font-bold text-emerald-400 flex items-center gap-1.5" data-testid="meta-readiness">
          ...
          <div className="bg-slate-900/60 p-3 rounded-xl border border-slate-800">
            ...
            <span className="font-bold text-sky-300 flex items-center gap-1.5" data-testid="meta-status">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800/80 border border-slate-700/80 rounded-2xl p-6 shadow-lg flex flex-col justify-between" data-testid="stage1-card">
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="px-2.5 py-1 rounded-lg bg-sky-500/20 text-sky-400 border border-sky-500/30 text-[11px] font-bold uppercase tracking-wider">
                Stage 1
              </span>
            ...
            <h2 className="text-lg font-bold text-white mb-1">{strings.dashboard.stage1Title}</h2>
            <p className="text-xs text-slate-400 leading-relaxed mb-4">{strings.dashboard.stage1Sub}</p>
          </div>

          <div className="space-y-2 pt-2 border-t border-slate-700/60">
            <button
              onClick={() => onLaunchTest?.('oir')}
              className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs transition-all shadow-md shadow-sky-900/30"
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl bg-slate-700/80 hover:bg-slate-700 border border-slate-600/60 text-slate-200 font-semibold text-xs transition-all"
            ...
            >
              ...
              <span className="text-[10px] text-slate-400 font-mono">30s view / 4m write</span>
            </button>
          </div>
        </div>

        {/* Stage II Psychology Battery Card */}
        <div className="bg-slate-800/80 border border-slate-700/80 rounded-2xl p-6 shadow-lg flex flex-col justify-between" data-testid="stage2-card">
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="px-2.5 py-1 rounded-lg bg-amber-500/20 text-amber-400 border border-amber-500/30 text-[11px] font-bold uppercase tracking-wider">
                Stage 2
              </span>
            ...
            <h2 className="text-lg font-bold text-white mb-1">{strings.dashboard.stage2Title}</h2>
            <p className="text-xs text-slate-400 leading-relaxed mb-4">{strings.dashboard.stage2Sub}</p>
          </div>

          <div className="pt-2 border-t border-slate-700/60">
            <button
              onClick={() => onLaunchTest?.('psychology')}
              className="w-full flex items-center justify-between px-4 py-3 rounded-xl bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-bold text-xs transition-all shadow-md shadow-amber-950/40"
      ...
      <div className="bg-slate-800/80 border border-slate-700/80 rounded-2xl p-6 shadow-lg">
        ...
        <div className="bg-slate-900/60 border border-slate-700/50 rounded-xl p-4 text-center">
          <p className="text-xs text-slate-400">{strings.dashboard.noReports}</p>
        </div>
      </div>
