...
export const Footer: FC<FooterProps> = ({ onNavClick }) => {
  return (
    <footer className="w-full bg-slate-950 border-t border-slate-800 text-slate-400 py-8 px-4 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left border-b border-slate-800/80 pb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-sm font-bold text-slate-100 tracking-wide uppercase">{strings.common.appName}</span>
